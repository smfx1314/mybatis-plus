...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        pc.setParent("com.jiangfeixiang.mp");
        ...
        strategy.setSuperEntityClass("com.jiangfeixiang.mp.common.BaseEntity");
        //设置自定义继承的Controller类全称，带包名
        strategy.setSuperControllerClass("com.jiangfeixiang.mp.common.BaseController");
